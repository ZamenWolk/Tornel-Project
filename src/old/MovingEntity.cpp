...
MovingEntity::MovingEntity() : m_levelMap(0)
{

}

MovingEntity::MovingEntity(LevelMap *levelMap, int xPos, int yPos) : m_levelMap(levelMap)
{
...
bool MovingEntity::canMove(Direction direction) const
{
    ...
    int         *mapArray = m_levelMap->getMapArray(),
                mapHeight = m_levelMap->getMapHeight(),
                mapWidth = m_levelMap->getMapWidth();
