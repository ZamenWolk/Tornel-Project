...
public:
    ...
    */
    ...
    ServerClient* connect(sf::TcpListener* listener, sf::SocketSelector *socketSelector = 0)
    {
        ...
        if (eventsStructure.versEv_number.status == AutoVersion::STATUS
            && eventsStructure.versEv_number.major == AutoVersion::MAJOR)
        {
    ...
    */
    ...
    void newEvent(std::vector<EntityInformations>& teamInfo,
                  bool isTeam1)
    {
    ...
    */
    ...
    void newEvent(const VersionNumber& versionNumber,
                  bool isTeam1)
    {
...
bool findOpenSubserver(std::vector<FightSubserver*> &serverVector,
